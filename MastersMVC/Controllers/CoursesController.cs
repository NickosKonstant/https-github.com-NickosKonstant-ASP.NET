...
namespace MastersMVC.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Category,WebsiteLink,Description,Fees,ApplicationDueDay")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Category,WebsiteLink,Description,Fees,ApplicationDueDay")] Course course)
        {
            if (ModelState.IsValid)
            {
